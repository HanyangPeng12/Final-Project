...
Through using the scale() command towards to original dataset, the accuracy rate of K-meas cluster increases in this experiment.
...
### How scale() command affects the results
Through using the scale() command towards to original dataset, the accuracy rate of K-meas cluster decreases in this experiment.
